<?php if (!empty($posts)) : foreach ($posts as $post) : ?>
        <div class="col-sm-12 col-md-3 col-lg-3">
            <div class="thumbnail">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a class="btn btn-xs btn-primary" id="beli-item<?php echo $post['kode_item']; ?>" onclick="beli(this)" data-barcode="<?php echo $post['kode_item']; ?>"><i class="fa fa-shopping-cart"></i> Beli Produk</a>
                    </div>
                </div>
            </div>
        </div>
