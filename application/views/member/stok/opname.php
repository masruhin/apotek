...
<html class="fixed sidebar-left-collapsed">
  ...
  <body class="bgbody">
    ...
    <div class="modal fade bd-example-modal-lg" id="verifikasiData" tabindex="-1" role="dialog"
            ...
            <header class="panel-heading">
              <div class="row show-grid">
                ...
                <div class="col-md-6" align="right">
                  ...
                  <button type="submit" class="btn btn-primary" id="verifikasisubmit"><i class="fa fa-check-circle"></i>
                    Verifikasi</button>
                  <button type="submit" class="btn btn-danger" id="verifikasihapus"><i class="fa fa-trash-o"></i>
                    Hapus</button>
                </div>
              </div>
            </header>
              ...
              <div class="form-group kode_item">
                ...
                <div class="col-sm-9">
                  <div class="input-group input-group-icon">
                    <input type="text" name="kode_item" data-toggle="modal" data-target="#modal-listitems"
                      class="form-control kode-item" required />
    ...
    <div class="modal fade bd-example-modal-lg" id="modal-listitems" tabindex="-1" role="dialog"
      aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $.each(response, function(i, item) {
            ...
            datarow += "<tr><td>Stok Sebelumnya</td><td>: " + item.stok_sebelum + " " + item.satuan_kecil +
              "</td></tr>";
            datarow += "<tr><td>Stok Berkurang</td><td>: " + item.kuantiti_berubah + " " + item.satuan_kecil +
              "</td></tr>";
